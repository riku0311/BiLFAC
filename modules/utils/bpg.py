...
class BinaryCodec(Codec):
    ...
    def _run_impl(self, in_filepath, quality):
        ...
        #################################################################
        """
        with open(out_filepath, 'rb') as file:
        ...
        binary_filename = '/home/21x3109_takahashi/hdac/modules/utils/bpg.bin'
        with open(binary_filename, 'wb') as file:
          file.write(binary.encode());
        
        bpg_size=os.path.getsize(binary_filename)*8
        #################################################################
        breakpoint()"""
...
class BPG(BinaryCodec):
    ...
    def __init__(self, color_mode="rgb", encoder="x265",
                        ...
                        encoder_path='/home/21x3109_takahashi/bpgenc', decoder_path='/home/21x3109_takahashi/bpgdec'):
        self.fmt = ".bpg"
