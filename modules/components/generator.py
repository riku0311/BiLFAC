...
class GeneratorBiLFAC(GeneratorDAC):
    def __init__(self, num_channels: int=3, num_kp : int =10, block_expansion: int =64, 
        ...
        super(GeneratorBiLFAC, self).__init__(num_channels, num_kp, block_expansion, max_features, num_down_blocks,
    ...
    def forward(self, source_image: torch.Tensor,base_layer: torch.Tensor, kp_source: Dict[str, torch.Tensor]=None,
                      kp_driving: Dict[str, torch.Tensor] = None) -> Dict[str, Any]:       
